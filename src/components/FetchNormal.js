...
function FetchNormal(props) {
    ...
    return (
        <div className="data-container">
            <Button style={{ display: "block", marginLeft: "auto", marginRight: "auto" }} variant="contained" onClick={dataHandler}>FetchNormal</Button>
...
export default connect(mapStateToProps, mapDispatchTpProps)(FetchNormal)
